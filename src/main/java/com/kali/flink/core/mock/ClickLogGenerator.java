package com.kali.flink.core.mock;
...
public class ClickLogGenerator {
    public static void main(String[] args) throws InterruptedException {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "acquirel:9092");
        props.put("acks", "all");
        props.put("retries", 2);
        ...
        for (int i = 0; i < 100; i++) {
            ...
            //发送数据
            ProducerRecord<String, String> record = new ProducerRecord<>("clickLog", msgJson);
